  ...
  <body class="app sidebar-mini rtl">
    ...
    <script type="text/javascript">
      ...
      function fetchUsers() {
        ...
        data_string='action=getPopularCategories';
        $.ajax({
            type: "GET",
            url: "../ajax.php",
            data: data_string,
            ...
            success: function(html){
              ...
              for (var i = 0; i < data.CATEGORIES.length; i++) {
                ...
                var avator = data.CATEGORIES[i].AVATOR;
                var name = data.CATEGORIES[i].CATEGORY;
                htmli=['<tr><td>'+id+'</td>'+
                	'<td><a href="category_data.php?id='+id+'&avator='+avator+'&name='+name+'">'+
                  '<img src="../classes/fileload/'+avator+'" class="avatar" alt="Avatar"/>'+
                  '</a></td><td>'+name+'</td></tr>'].join('');
                  htm+=htmli;
                ////////////////////////////////////////
              }
              htm+='</tbody>';
      ...
      function viewCategory(id, avator, name) {
        alert("lol");
      }
