...
<ul class="app-nav">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user">
        ...
        <div>
          ...
          <p class="app-sidebar__user-designation">Client's Orders</p>
        </div>
      </div>
      <ul class="app-menu">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-users"></i> Client's Orders</h1>
          <p>.........Get Gear</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item active"><a href="#">Client's Orders</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
    ...
    <script type="text/javascript">
      ...
      function fetchUsers() {
        ...
        data_string='action=getClientsOrders';
        $.ajax({
            type: "GET",
            url: "../ajax.php",
            data: data_string,
              ...
              for (var i = data.ORDERS.length-1; i > 0; i--) {
                ...
                htmli=['<tr>'+
                  '<td>'+id+'</td>'+
                	...
                	'<img src="../classes/fileload/'+avator+'" class="avatar" alt="Avatar"/> '+name+'</br>'+email+'</br>'+phone+'</a></td></a>'+
                    '<td onclick=getItemProfile("'+data.ORDERS[i].ITEM_ID+'")><a href="#"><img src="../classes/fileload/'+data.ORDERS[i].IMAGES+'" class="avatar" alt="Avatar"/> '+data.ORDERS[i].ITEM_NAME+'</br>UGX'+data.ORDERS[i].ITEM_PRICE+'</a></td>'+
